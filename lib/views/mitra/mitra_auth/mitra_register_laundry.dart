                                ...
                                child: CustomButton()
                                  ...
                                  () {
                                    final mitraRegisterBloc =
                                        BlocProvider.of<MitraRegisterBloc>(
                                            context);
                                    mitraRegisterBloc.add(
                                      MitraRegisterButtonPressed(
                                        mitraRegisterRequestModel:
                                          ...
                                          hargaKering: handleEmpty(
                                              laundryCuciKering.text),
                                          hargaBasah: handleEmpty(
                                              laundryCuciBasah.text),
                                          hargaSatuan: handleEmpty(
                                              laundryCuciSatuan.text),
                                          gambar: "",
                                          jamBuka: "08:00 - 17.00",
                                        ),
                                      ),
